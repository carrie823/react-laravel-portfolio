  ...
  return(
    <main id="main">
      ...
      <div id="home-about">
        ...
        <p>Welcome to my portfolio! I'm a frontend developer and a digital illustrator. Take a look around, I might be the web dev you've been looking for to make your website a reality!</p>
      </div>
      <div class="pic">
